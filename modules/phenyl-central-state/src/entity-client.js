...
export class PhenylEntityClient<M: EntityMap> implements EntityClient<M> {
   ...
   *
   */
  async insertOne<N: $Keys<M>>(command: SingleInsertCommand<N, $ElementType<M, N>>): Promise<SingleInsertCommandResult> {
   ...
   *
   */
  async insertMulti<N: $Keys<M>>(command: MultiInsertCommand<N, $ElementType<M, N>>): Promise<MultiInsertCommandResult> {
   ...
   *
   */
  async insertAndGet<N: $Keys<M>>(command: SingleInsertCommand<N, $ElementType<M, N>>): Promise<GetCommandResult<$ElementType<M, N>>> {
   ...
   *
   */
  async insertAndGetMulti<N: $Keys<M>>(command: MultiInsertCommand<N, $ElementType<M, N>>): Promise<MultiValuesCommandResult<$ElementType<M, N>, *>> {
